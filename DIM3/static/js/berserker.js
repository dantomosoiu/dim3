...
$(document).ready(function () {
    ...
    the_tabs.click(function(e){
        ...
        if(!element.data('cache'))
        {
            ...
            var loadImgLoc = "<img src=".concat(STATIC_URL + "/img/ajax_preloader.gif  width=\"64\" height=\"64\" class=\"preloader\" />");
            $('#contentHolder').html('<img src="' + STATIC_URL + 'img/ajax_preloader.gif" width="64" height="64" class="preloader" />');
